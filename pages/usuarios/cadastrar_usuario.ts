...
$("form").on('submit',
    (e) => {
        ...
        let formulario = new Usuario(
            String($("#nome_form").val()),
            String($("#email_form").val()),
            String($("#senha_form").val()),
        )
...
function escreveLinha(usuario: Usuario) {
    $("tbody").append(
        $("<tr>").append(
            $("<td>", { text: usuario.getNome() }),
            $("<td>", { text: usuario.getEmail() }),
            $("<td>", { text: usuario.getSenha() }),
            $("<td>").append(
                $("<button>",
                    {
                        text: "deletar",
...
function adicionar(novoUsuario: Usuario) {
...
function atualizar(alteracaoUsuario: Usuario) {
